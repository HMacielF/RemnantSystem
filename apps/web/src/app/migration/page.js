  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#f5efe7_0%,#efe6dc_28%,#e9edf3_100%)] px-6 py-10 text-[#1f2937]">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <section className="overflow-hidden rounded-[32px] border border-white/70 bg-[linear-gradient(135deg,rgba(18,31,51,0.94),rgba(42,64,95,0.88))] px-8 py-8 text-white shadow-hero">
