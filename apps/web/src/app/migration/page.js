export default function MigrationPage() {
 ...
 <section className="overflow-hidden rounded-sm border border-white/70 bg-[linear-gradient(135deg,rgba(18,31,51,0.94),rgba(42,64,95,0.88))] px-8 py-8 text-white ">
 ...
 <article
 key={item}
 className="rounded-sm border border-white/70 bg-white/90 p-6 "
 >
 <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#a16235]">
 Status
 </p>
 <h2 className="font-inter mt-3 text-xl font-semibold text-[#18212d]">{item}</h2>
 </article>
 ))}
 </section>
 </div>
