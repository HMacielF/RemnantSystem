...
export default function OverviewPage() {
 ...
 <section className="overflow-hidden rounded-sm border border-white/70 bg-[linear-gradient(135deg,rgba(18,31,51,0.96),rgba(42,64,95,0.88))] px-8 py-8 text-white ">
 <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
 <div className="max-w-3xl">
 <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#f7bf97]">
 Workspace Overview
 </p>
 <h1 className="font-inter mt-3 max-w-3xl text-4xl font-semibold leading-tight">
 ...
 <div className="rounded-sm border border-white/15 bg-white/10 p-5 text-sm text-slate-100 ">
 ...
 <article
 key={route.href}
 className="flex flex-col justify-between rounded-sm border border-white/70 bg-white/90 p-6 "
 >
 <div>
 <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#a16235]">
 {route.eyebrow}
 </p>
 <h2 className="font-inter mt-3 text-xl font-semibold text-[#18212d]">{route.title}</h2>
 <p className="mt-3 text-sm leading-6 text-[#5d6a78]">{route.body}</p>
 </div>
 <Link
 href={route.href}
 className="mt-6 inline-flex h-11 items-center justify-center rounded-sm bg-[#152238] px-5 text-sm font-semibold text-white transition-colors hover:bg-[#f08b49]"
 >
 Open {route.href}
 </Link>
 </article>
 ...
 <article className="rounded-sm border border-white/70 bg-white/92 p-6 ">
 <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#a16235]">
 Current Setup
 </p>
 <h2 className="font-inter mt-3 text-2xl font-semibold text-[#18212d]">The app is set up for day-to-day use.</h2>
 <div className="mt-4 grid gap-3 md:grid-cols-2">
 <div className="rounded-sm border border-[#eadfd7] bg-[#fff8f2] p-4 text-sm leading-6 text-[#5f5146]">
 ...
 <article className="rounded-sm border border-white/70 bg-[linear-gradient(180deg,#fff7f0_0%,#fffdfb_100%)] p-6 ">
 <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#a16235]">
 Focus
 </p>
 <h2 className="font-inter mt-3 text-2xl font-semibold text-[#18212d]">Keep improving workflow depth and polish.</h2>
