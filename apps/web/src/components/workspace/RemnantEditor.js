        ...
        <div className="mx-auto max-w-6xl overflow-visible rounded-[32px] border border-[var(--brand-line)] bg-white shadow-[0_24px_70px_rgba(25,27,28,0.14)]">
          ...
          <form onSubmit={onSave} className="grid gap-4 p-6 md:grid-cols-2">
                        ...
                        <div className="absolute left-0 right-0 top-[calc(100%+0.5rem)] z-20 overflow-hidden rounded-[22px] border border-[var(--brand-line)] bg-white shadow-[0_20px_40px_rgba(25,27,28,0.12)]">
                          <div className="max-h-64 overflow-y-auto p-2">
                            {filteredEditorBrandSuggestions.map((brand) => (
                              ...
                              >
                                <span className="block truncate text-sm font-semibold text-[var(--brand-ink)]">{brand}</span>
                              </button>
                            ))}
                          </div>
                        </div>
                  ...
                  <>
                    ...
                    <div className="mt-4 grid gap-4 xl:grid-cols-12">
                      <label className="block text-sm font-medium text-[rgba(35,35,35,0.78)] xl:col-span-4">
                        Slab Name
                        <input type="text" value={editorSlabForm.name} onChange={(event) => updateEditorSlabField("name", event.target.value)} className="mt-2 h-12 w-full rounded-2xl border border-[var(--brand-line)] bg-white px-4 text-sm text-[var(--brand-ink)] shadow-sm outline-none transition-colors focus:border-[var(--brand-orange)] focus:ring-4 focus:ring-[rgba(247,134,57,0.14)]" />
                      </label>
                      <label className="block text-sm font-medium text-[rgba(35,35,35,0.78)] xl:col-span-2">
                        Width
                        <input type="text" inputMode="decimal" value={editorSlabForm.width} onChange={(event) => updateEditorSlabField("width", event.target.value)} className="mt-2 h-12 w-full rounded-2xl border border-[var(--brand-line)] bg-white px-4 text-sm text-[var(--brand-ink)] shadow-sm outline-none transition-colors focus:border-[var(--brand-orange)] focus:ring-4 focus:ring-[rgba(247,134,57,0.14)]" />
                      </label>
                      <label className="block text-sm font-medium text-[rgba(35,35,35,0.78)] xl:col-span-2">
                        Height
                        <input type="text" inputMode="decimal" value={editorSlabForm.height} onChange={(event) => updateEditorSlabField("height", event.target.value)} className="mt-2 h-12 w-full rounded-2xl border border-[var(--brand-line)] bg-white px-4 text-sm text-[var(--brand-ink)] shadow-sm outline-none transition-colors focus:border-[var(--brand-orange)] focus:ring-4 focus:ring-[rgba(247,134,57,0.14)]" />
                      </label>
                      <label className="block text-sm font-medium text-[rgba(35,35,35,0.78)] xl:col-span-4">
                        Supplier URL
                        <input type="url" value={editorSlabForm.detail_url} onChange={(event) => updateEditorSlabField("detail_url", event.target.value)} className="mt-2 h-12 w-full rounded-2xl border border-[var(--brand-line)] bg-white px-4 text-sm text-[var(--brand-ink)] shadow-sm outline-none transition-colors focus:border-[var(--brand-orange)] focus:ring-4 focus:ring-[rgba(247,134,57,0.14)]" />
                      </label>
                      <label className="block text-sm font-medium text-[rgba(35,35,35,0.78)] xl:col-span-8">
                        Image URL
                        <input type="url" value={editorSlabForm.image_url} onChange={(event) => updateEditorSlabField("image_url", event.target.value)} className="mt-2 h-12 w-full rounded-2xl border border-[var(--brand-line)] bg-white px-4 text-sm text-[var(--brand-ink)] shadow-sm outline-none transition-colors focus:border-[var(--brand-orange)] focus:ring-4 focus:ring-[rgba(247,134,57,0.14)]" />
                      </label>
                    </div>
                          ...
                          {activeLookupColors.map((row) => {
                            ...
                            return (
                              <button
                                ...
                                aria-pressed={selected}
                              >
                                {selected ? <span className="h-3.5 w-3.5 rounded-full border border-white/75 bg-white/90 shadow-sm" /> : null}
                              </button>
                            );
                          })}
                        </div>
            ...
            <div className="md:col-span-2 flex flex-wrap justify-center gap-3 pt-2">
              ...
              {editorMode === "edit" ? (
                <button type="button" onClick={onArchive} className="inline-flex h-12 items-center justify-center rounded-2xl border border-stone-300 bg-stone-100 px-6 text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-200">
                  Archive
                </button>
              ) : null}
