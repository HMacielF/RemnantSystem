...
export function MyHoldsPanel({
 ...
 <h2 className="font-inter mt-1 text-2xl font-semibold text-[color:var(--qc-ink-1)]">Holds</h2>
 ...
 return (
 <article key={hold.id} className="rounded-sm border border-[color:var(--qc-line)] bg-[linear-gradient(180deg,#ffffff_0%,#fafafa_100%)] p-4 ">
 ...
 <p className="mt-2 break-words text-sm font-medium text-[color:var(--qc-ink-1)]">{requesterName}</p>
 </div>
 <div className="rounded-sm border border-[color:var(--qc-line)] bg-white p-4">
 <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--brand-orange)]">Email</p>
 <p className="mt-2 break-all text-sm font-medium text-[color:var(--qc-ink-1)]">{requesterEmail}</p>
 </div>
 <div className="rounded-sm border border-[color:var(--qc-line)] bg-white p-4">
 <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--brand-orange)]">Job</p>
 <p className="mt-2 text-sm font-medium text-[color:var(--qc-ink-1)]">{hold.job_number ? formatJobNumber(hold.job_number, holdRemnant) : "Unknown"}</p>
 </div>
 <div className="rounded-sm border border-[color:var(--qc-line)] bg-white p-4">
 <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--brand-orange)]">Expires</p>
 <p className="mt-2 text-sm font-medium text-[color:var(--qc-ink-1)]">{formatDateLabel(hold.expires_at)}</p>
 </div>
 </div>
