...
export function SoldEditor({
 ...
 <h2 className="font-inter text-2xl font-semibold text-[color:var(--qc-ink-1)]">Mark as Sold</h2>
 </div>
 <button
 type="button"
 onClick={onClose}
 className="h-10 w-10 rounded-full border border-[color:var(--qc-line)] bg-white text-xl text-[color:var(--qc-ink-1)] transition-colors hover:border-[var(--brand-orange)] hover:bg-[color:var(--qc-bg-page)]"
 >
 {"\u00D7"}
 </button>
 </div>
 ...
 Sales Rep
 <div className="mt-1 flex min-h-12 items-center rounded-sm border border-[color:var(--qc-line)] bg-[color:var(--qc-bg-page)] px-4 py-3 text-sm text-[color:var(--qc-ink-1)]">
 ...
 <button type="submit" className="inline-flex h-12 items-center justify-center rounded-sm border border-rose-200 bg-rose-100 px-6 text-sm font-semibold text-rose-800 transition-colors hover:bg-rose-200">
 Save Sale
 </button>
